...
export default function RolePermissionModal({
  ...
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-md flex items-center justify-center z-50 p-4 animate-in fade-in duration-200">
      <div className="bg-[#070d09] border border-emerald-500/25 rounded-3xl w-full max-w-4xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
        {/* Modal Header */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 bg-white/[0.02] border border-white/10 p-4 rounded-xl">
            <div>
              ...
              <input 
                ...
                className="w-full bg-[#070b14] border border-white/15 rounded-lg px-3 py-2 text-white focus:outline-none focus:border-emerald-400"
              />
            </div>
            ...
            <div>
              ...
              <select
                ...
                className="w-full bg-[#070b14] border border-white/15 rounded-lg px-3 py-2 text-white focus:outline-none focus:border-emerald-400 font-medium"
              >
                {ROLES_LIST.map(r => (
                  <option key={r.id} value={r.id} className="bg-[#070d09]">{r.label}</option>
                ))}
              </select>
            </div>
          </div>
              ...
              {adAccounts.map(acc => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className={`w-4 h-4 rounded border flex items-center justify-center ${isSelected ? 'bg-emerald-500 border-emerald-500' : 'border-gray-600'}`}>
                ...
                return (
                  ...
                  >
                    ...
                    <div className={`w-5 h-5 rounded-md border flex items-center justify-center flex-shrink-0 mt-0.5 transition-colors ${
                      isChecked ? 'bg-emerald-500 border-emerald-500' : 'border-gray-600 bg-black/20'
                    }`}>
        ...
        <div className="flex items-center justify-between px-6 py-4 border-t border-white/10 bg-white/[0.02]">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              type="button"
              onClick={handleSave}
              className="px-5 py-2 bg-gradient-to-r from-emerald-500 to-teal-600 hover:opacity-95 text-white font-bold uppercase font-levents rounded-xl shadow-lg shadow-emerald-950/40 transition-all cursor-pointer"
            >
              Lưu Phân Quyền
            </button>
          </div>
